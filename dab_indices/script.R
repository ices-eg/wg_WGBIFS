...
grid = getBathyGrid(d,minDepth=5,maxDepth=190,resolution=3,maxDist=0.2,shapefile="~/Documents/shapefiles/ICES_areas.shp",select="ICES_SUB")
...
grid2124 = getBathyGrid(d,minDepth=5,maxDepth=190,resolution=3,maxDist=0.2,shapefile="~/Documents/shapefiles/ICES_areas.shp",select="ICES_SUB")
