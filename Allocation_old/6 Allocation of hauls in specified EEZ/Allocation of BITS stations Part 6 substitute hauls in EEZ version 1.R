...
write.table(extrahauls, "H:/Active nonsystem/ICES WG/WGBIFS/Surveys/Allocating of BITS stations/Allocation/5 Allocation of extra hauls/Output files/Extra hauls EST.csv", sep=";")
