...
####################################################################################################################################
#Part 5 of Haul allocation program for BITS (stratified random sampling)

#The program select extra hauls for given Sub-dicision and depth interval. 
...
TD<-read.table("H:/Active nonsystem/ICES WG/WGBIFS/Surveys/Allocating of BITS stations/Trawl database/Database/TD_2017_V1 HD version.csv",header=TRUE,sep=";")
TotalHaulsToBeFished <- read.table("H:/Active nonsystem/ICES WG/WGBIFS/Surveys/Allocating of BITS stations/Allocation/3 Allocation of hauls to country/Output files/list of totalallocated hauls processed.csv", header=TRUE, sep=";")
...
#write.table(extrahauls, "H:/Active nonsystem/ICES WG/WGBIFS/Surveys/Allocating of BITS stations/Allocation/5 Allocation of extra hauls/Output files,paste(name, sep = ""))

write.table(extrahauls, "H:/Active nonsystem/ICES WG/WGBIFS/Surveys/Allocating of BITS stations/Allocation/5 Allocation of extra hauls/Output files/Extra hauls LAT.csv", sep=";")
