...
TotalHaulsToBeFished <- read.table("H:/Active nonsystem/ICES WG/WGBIFS/Surveys/Allocating of BITS stations/Allocation/3 Allocation of hauls to country/Output files/list of total allocated hauls processed 1q2018.csv", header=TRUE, sep=";")
...
write.table(extrahauls, "H:/Active nonsystem/ICES WG/WGBIFS/Surveys/Allocating of BITS stations/Allocation/5 Allocation of extra hauls/Output files/Extra hauls DEN 1q 2018 5.csv", sep=";")
